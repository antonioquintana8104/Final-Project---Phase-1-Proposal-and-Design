...
The program uses the external CSV file "database.csv" which must be downloaded before running the program. This CSV file contains information from the recommendations such as name, type of media, genre, description, cultural information, and user ratings.
...
To run the program you need to download the Python file named "version1.py" and the CSV file named "database.csv" and place them in the same folder.
