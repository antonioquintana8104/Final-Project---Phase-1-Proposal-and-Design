...
The program uses the external Excel file "database.xlsx" which must be downloaded before running the program. This Excel file contains information from the recommendations such as name, type of media, genre, description, cultural information, and user ratings.
